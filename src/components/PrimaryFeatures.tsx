...
import {Global, Magicpen, Map} from 'iconsax-react';
...
const features = [
  {
    name: 'Организовывайте мероприятия',
    description:
      'Находите друзей и опубликовывайте посты в форуме, делитесь моментами и идеями',
    icon: <Magicpen
        size="32"
        color="gray"
    />,
  ...
  {
    name: 'Исследуйте Карту Соотечественников',
    description:
      'Откройте для себя места сбора казахов рядом с вами и соединяйтесь с соседями по духу.',
    icon: <Map
        size="32"
        color="gray"
    />,
  ...
  },
  {
    ...
    description:
      'Делись культурными особенностями и традициями Казахстана, обогащая мировое сообщество.',
    icon: <Global
        size="32"
        color="gray"
    />,
    ...
    >
      ...
      <div className="relative col-span-6">
        ...
        <PhoneFrame className="z-10 mx-auto w-full max-w-[366px]">
          <img src='https://i.imgur.com/vzwkbCb.jpg' alt='lg' />
        </PhoneFrame>
      </div>
    </Tab.Group>
  )
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          <p className="mt-2 text-lg text-gray-400">
            Исследуйте уникальные функции, созданные специально для объединения казахстанцев по всему миру.
          </p>
        </div>
      </Container>
